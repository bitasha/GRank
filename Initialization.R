...
source(paste(getwd(),'/GRank.R',sep=""))
...
res=rankEvaluation_Yu_GRank(rmat,userSeq = usersequence,trl=10,direc = "~/g-res.csv",firstRun = 1,simflag = 0,damping = 0.85,trainflag = 1,trdirec = trdir)
